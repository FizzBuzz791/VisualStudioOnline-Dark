...
--				ON (L.Parent_Location_Id = HL.LocationId)
		...
		INSERT INTO @historicData (TagId, LocationId, MaterialTypeId, CalendarDate, DateFrom, DateTo, DateBreakdown, Tonnes, Fe, P, SiO2, Al2O3, LOI)
		SELECT his.TagId, his.LocationId, his.MaterialTypeId, his.CalendarDate, his.DateFrom, his.DateTo, his.DateBreakdown, his.Tonnes, his.Fe, his.P, his.SiO2, his.Al2O3, his.LOI
		...
		BEGIN
			...
			DECLARE @quarterlyTags TABLE (TagId VARCHAR(124))
