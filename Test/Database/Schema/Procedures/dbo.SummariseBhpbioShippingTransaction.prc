...
BEGIN
	...
	BEGIN TRY
		...
		GROUP BY SP.HubLocationId, SI.ProductSize
		UNION ALL 
		SELECT	@summaryId,
				@summaryEntryTypeId,
				SP.HubLocationId,
		...
		SELECT	bse.SummaryEntryId,
				SG.GradeId,
				SUM(SG.GradeValue * SI.Tonnes) / SUM(SI.Tonnes)
		FROM	@ShippingItem SI 
			INNER JOIN BhpbioShippingNominationItemParcel SP 
				ON SP.BhpbioShippingNominationItemParcelId = SI.BhpbioShippingNominationItemParcelId
			INNER JOIN dbo.BhpbioSummaryEntry bse 
				...
				INNER JOIN dbo.BhpbioShippingNominationItemParcelGrade AS SG 
					ON SP.BhpbioShippingNominationItemParcelId = SG.BhpbioShippingNominationItemParcelId
