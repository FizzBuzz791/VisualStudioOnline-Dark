	...
	BEGIN TRY
		...
		BEGIN
			...
			BEGIN
				...
				INNER JOIN BhpbioStratigraphyHierarchy BSH1 -- Used to pull out StratNum or whatever we finally decide to display.
				...
				INNER JOIN BhpbioStratigraphyHierarchyType BSHT
