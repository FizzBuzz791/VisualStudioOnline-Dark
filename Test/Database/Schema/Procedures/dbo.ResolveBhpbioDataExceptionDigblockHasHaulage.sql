 IF OBJECT_ID('dbo.ResolveBhpbioDataExceptionDigblockHasHaulage') IS NOT NULL
     DROP PROCEDURE dbo.ResolveBhpbioDataExceptionDigblockHasHaulage
GO 
  
CREATE PROCEDURE dbo.ResolveBhpbioDataExceptionDigblockHasHaulage
(
...
BEGIN 
	...
	SELECT @TransactionName = 'ResolveBhpbioDataExceptionDigblockHasHaulage',
	...
	BEGIN TRY
		...
		BEGIN
			-- if marked as active
			IF @dataExceptionStatusId = 'A'
			BEGIN
				-- make the data exception resolved
...
GRANT EXECUTE ON dbo.ResolveBhpbioDataExceptionDigblockHasHaulage TO BhpbioGenericManager
GO
