...
(
	...
	@iStartDate DATETIME,
	@iEndDate DATETIME,
	@iLowestLocationTypeName NVARCHAR(20) = 'PIT' -- Defaulting to PIT to prevent any regression
)
WITH ENCRYPTION
AS 
BEGIN
	...
	FROM GetBhpbioReportLocationBreakdownWithOverride(@topLocationId, 0, @iLowestLocationTypeName, @iStartDate, @iEndDate) AS bl
