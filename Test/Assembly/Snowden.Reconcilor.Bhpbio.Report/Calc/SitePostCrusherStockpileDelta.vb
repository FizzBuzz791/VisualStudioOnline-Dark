...
Namespace Calc
    Public Class SitePostCrusherStockpileDelta
        Inherits CalculationBasic

        Public Const CalculationId As String = "SitePostCrusherStockpileDelta"
        Public Const CalculationDescription As String = "Site ∆Post-Crusher Stockpile"
        ...
        Protected Overrides ReadOnly Property GetCache() As Cache.DataCache
            Get
                Return Session.GetCacheActualSitePostCrusherStockpileDelta()
            End Get
        End Property
