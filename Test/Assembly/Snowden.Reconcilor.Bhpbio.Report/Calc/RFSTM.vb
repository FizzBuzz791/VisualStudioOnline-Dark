...
Namespace Calc
    Public NotInheritable Class RFSTM
        ...
        Public Const CalculationId As String = "RFSTM"
        Public Const CalculationDescription As String = "RFSTM - Mine Production (Expit) / Short Term Model"
        ...
        Protected Overrides Sub SetupOperation()
            ...
            Dim shortTermGeologyModelResult As CalculationResult = Calculation.Create(CalcType.ModelShortTermGeology, Session).Calculate()
            ...
            If Session.IncludeResourceClassification Then
                ...
                shortTermGeologyModelResult.RemoveResourceClassificationRows()
            End If

            shortTermGeologyModelResult.PrefixTagId("RFSTM")
            mineProductionExpitEquivalentResult.PrefixTagId("RFSTM")

            Calculations.Add(New CalculationOperation(CalculationStep.Assign, mineProductionExpitEquivalentResult))
            Calculations.Add(New CalculationOperation(CalculationStep.Divide, shortTermGeologyModelResult))
        End Sub
        ...
        Protected Overrides Sub ProcessTags()
            ...
            difference = CalculationResult.PerformCalculation(mineProductionExpitEquivalentResult, shortTermGeologyModelResult, CalculationType.Difference)
