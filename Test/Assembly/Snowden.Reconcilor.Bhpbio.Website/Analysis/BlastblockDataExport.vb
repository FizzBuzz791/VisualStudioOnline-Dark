...
Namespace Analysis
    Public Class BlastblockDataExport
...
#End Region
        ...
        Protected Overrides Sub HandlePageSecurity()
            If (CheckSecurity AndAlso (Not Resources.UserSecurity.HasAccess("ANALYSIS_BLASTBLOCK_DATA_EXPORT"))) Then
                ReportAccessDenied()
            End If
        ...
        Protected Overrides Sub SetupPageControls()
            ...
            FilterBox.GroupBoxTitle = " Blastblock Data Export "
            FilterBox.SubmitAction = "../Reports/GetBlastblockDataExportReport.aspx"
            ...
            If Integer.TryParse(Resources.UserSecurity.GetSetting("Blastblock_Data_Export_Location_Id"), locationId) Then
                FilterBox.LocationId = locationId
            End If

            Dim defaultDatesRequired As Boolean = False
            Dim startDate As DateTime
            If DateTime.TryParse(Resources.UserSecurity.GetSetting("Blastblock_Data_Export_Date_From"), startDate) Then
            ...
            If DateTime.TryParse(Resources.UserSecurity.GetSetting("Blastblock_Data_Export_Date_To"), endDate) Then
            ...
            FilterBox.ApprovalSelection = Resources.UserSecurity.GetSetting("Blastblock_Data_Export_Approval_Status", String.Empty)
