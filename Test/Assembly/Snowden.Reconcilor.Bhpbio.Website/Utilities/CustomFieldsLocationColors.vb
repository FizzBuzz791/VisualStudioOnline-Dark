...
Namespace Utilities
    Public Class CustomFieldsLocationColors
...
#Region " Properties "
        ...
        Private _reportingThresholdBox As New GroupBox("Reporting Threshold")
        Private _locationsTreeDiv As New Tags.HtmlDivTag("locationColorsTree")
        Private _locationsDetailsDiv As New Tags.HtmlDivTag("locationColorsDetails")
        Private _layoutTable As New Tags.HtmlTableTag()
        Private _locationPicker As New Bhpbio.WebDevelopment.ReconcilorControls.Inputs.LocationPicker("LocationPicker3")
        ...
        Protected ReadOnly Property ReportingThresholdBox() As GroupBox
            Get
                Return _reportingThresholdBox
            End Get
        End Property
            ...
            Try
                If (Not _disposed) Then
                    If (disposing) Then
                        ...
                        If (Not ReportingThresholdBox Is Nothing) Then
                            _reportingThresholdBox.Dispose()
                            _reportingThresholdBox = Nothing
                        End If
...
#End Region
        ...
        Protected Sub SetupPageControls()
            ...
            ReportingThresholdBox.Width = 410
            ...
            With LayoutTable
                ...
                .AddCell().Controls.Add(ReportingThresholdBox)
                .CurrentCell.VerticalAlign = Web.UI.WebControls.VerticalAlign.Top
            End With

            With LocationsDetailsDiv
                .Controls.Add(New LiteralControl("Select a location to view the Threshold."))
            End With

            With LocationPicker
                .LowestLocationTypeDescription = "PIT"
                .PopupTable = False
                .LocationJavaScript = "LoadLocationColorsDetails"
                .Width = 180
        ...
        Protected Sub SetupPageLayout()
            ...
            ReportingThresholdBox.Controls.Add(LocationsDetailsDiv)
