...
Namespace Utilities
    Public Class CustomFieldsLocations
...
#Region " Properties "
        ...
        Private _locationsTreeDiv As New Tags.HtmlDivTag("locationsTree")
        Private _locationsDetailsDiv As New Tags.HtmlDivTag("locationsDetails")
        Private _layoutTable As New Tags.HtmlTableTag()
        Private _locationPicker As New Bhpbio.WebDevelopment.ReconcilorControls.Inputs.LocationPicker("LocationPicker")
...
#End Region
        ...
        Protected Sub SetupPageControls()
            ...
            With LocationPicker
                .PopupTable = False
                .LocationJavaScript = "LoadLocationsDetails"
                .Width = 180
