...
--
-- this will delete results just processed
--

-- delete resource classification data for blocks just processed
DELETE mbpv
...
WHERE mbpv.Model_Block_Partial_Field_Id LIKE 'Res%' AND t.Processed = 1
GO

-- delete summary data for blocks just processed
DELETE fv
